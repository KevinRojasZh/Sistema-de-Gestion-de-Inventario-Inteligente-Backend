...
*/
productRouter.post('/',middleware.tokenExtractor,middleware.userExtract,async(request, response) => {
 ...
 */
productRouter.delete('/:id',middleware.tokenExtractor,middleware.userExtract,async(request, response) => {
 ...
 */
productRouter.get('/:id',middleware.tokenExtractor,middleware.userExtract,async(request, response) => {
 ...
 */
productRouter.patch('/:id',middleware.tokenExtractor,middleware.userExtract, async(request, response) => {
    const id = request.params.id
    ...
    try{
        ...
        const updateProduct =  await Product.findByIdAndUpdate(id,body,{ new:false,runValidators:true })
